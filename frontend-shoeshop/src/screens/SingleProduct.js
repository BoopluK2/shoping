...
import { PRODUCT_CREATE_REVIEW_RESET } from "../Redux/Constants/ProductCons";
...
const SingleProduct = ({ history, match }) => {
  ...
  const AddToCart = (e) => {
    e.preventDefault()
    history.push(`/cart/${productId}?qts=${qts}`)
  }
              ...
              <div className="product-count col-lg-7 ">
                ...
                {product.countInStock > 0 ? (
                  <>
                    <div className="flex-box d-flex justify-content-between align-items-center">
                      <h6>Quantity</h6>
                      <select value={qts} onChange={(e) => setQts(e.target.value)}>
